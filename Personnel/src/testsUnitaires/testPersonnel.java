...
class testPersonnel
{
	...
	@Test
	void getArrivé() throws SauvegardeImpossible
	{
		Ligue ligue = gestionPersonnel.addLigue("Fléchettes");
		...
		assertEquals(LocalDate.parse("2019-11-22"), employe.get_date_arrivé());
	}
	...
	void getDepart() throws SauvegardeImpossible
	{
		Ligue ligue = gestionPersonnel.addLigue("Fléchettes");
		Employe employe = ligue.addEmploye("Bouchard", "Gérard", "g.bouchard@gmail.com", "azerty", LocalDate.parse("2019-11-22"), LocalDate.parse("2023-01-13")); 
		assertEquals(LocalDate.parse("2023-01-13"), employe.get_date_depart());
	}
}
